...
class Range(QWidget):
    def __init__(self):
        ...
        self.Add_Peak_Btn.clicked.connect(self.InsertPeak)
        self.Remove_Peak_Btn.clicked.connect(self.RemovePeak)
        self.clickcount = 0 
...
# Hide and show Profile_fixed textbox based on checked and unchecked state
        
        self.bg_fixed_lineEdit.setVisible(False)
        self.bg_fixed_checkbox.stateChanged.connect(self.onActivated)
        
        # DisableSave Button after First Click
