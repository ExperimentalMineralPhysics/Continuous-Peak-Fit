    ...
    if input_file.exists():
        ...
        try:
            with open(input_file, "w", encoding="utf-8") as file:
                ...
                file.write("Calib_data     = datafile_directory + 'CeO2_Pil207_E30_2Nov2016_001.tif'\n")
                file.write("Calib_param    = datafile_directory + 'CeO2_cal_Dioptas.poni'\n")
                file.write("Calib_mask     = datafile_directory + 'DiffractionMask_Dioptas.mask'\n")
                ...
                file.write("              'symmetry': 2\n")
                file.write("            }],\n")
                file.write("#          'PeakPositionSelection': [[1,-120.5,23.226],[1,-58.997,23.186],[1,59.289,23.208],[1,23.187,120.893],[1,23.212,6.367], [1,23.158,90.025], [1,23.246,25.729]]\n")
