...
import cpf
from cpf.gui.matplotlib_qt import matplotlib_qt
from cpf.gui.output_widget import Output
from cpf.gui.peak_widget import Peak
from cpf.gui.range_widget import Range
from cpf.util.logging import get_logger

logger = get_logger("cpf.gui.main_widget")


class MainWidget(QMainWindow):
    def __init__(self):
        super(MainWidget, self).__init__()
        loadUi("Widgets/MainWidget.ui", self)
    ...
    def Load_Inputs(self):
        ...
        fname = QFileDialog.getOpenFileName(
            self, "Load Input File", "./", "Python Files (*.py)"
        )
        ...
        self.cascade_number_bins.editingFinished.connect(
            self.Cascade_number_bins_Pressed
        )
        ...
        for range_tab in range(0, self.range_length):
            ...
            range_object.Range_min.setText(
                str(self.set_cl.fit_orders[range_tab].get("range")[0])
            )

            range_object.Range_max.setText(
                str(self.set_cl.fit_orders[range_tab].get("range")[1])
            )

            range_object.Range_Background_Val.setText(
                str(self.set_cl.fit_orders[range_tab].get("background"))
            )
            range_object.Intensity_max.setText(
                str(self.set_cl.fit_orders[range_tab].get("imax"))
            )

            range_object.Intensity_min.setText(
                str(self.set_cl.fit_orders[range_tab].get("imin"))
            )
            range_object.Peak_Pos_Selection.setPlainText(
                str(self.set_cl.fit_orders[range_tab].get("PeakPositionSelection"))
            )
            ...
            if self.set_cl.fit_orders[range_tab].get("background-type") == None:
                ...
                self.b_type = str(
                    self.set_cl.fit_orders[range_tab].get("background-type")
                )
            ...
            for peak_tab in range(0, self.peak_length):
                ...
                peak_object.phase_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("phase")
                    )
                )

                peak_object.hkl.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("hkl")
                ...
                peak_object.d_space_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("d-space")
                ...
                peak_object.height_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("height")
                ...
                peak_object.profile_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("profile")
                ...
                peak_object.profile_fixed.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("profile_fixed")
                ...
                peak_object.width_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("width")
                ...
                peak_object.symmetry_peak.setText(
                    str(
                        self.set_cl.fit_orders[range_tab]
                        .get("peak")[peak_tab]
                        .get("symmetry")
                ...
                if (
                    ...
                    peak_object.dspace_fixed.setText(
                        str(self.set_cl.fit_orders[range_tab].get("profile_fixed"))
                    )
                ...
                if (
                    ...
                    peak_object.width_fixed.setText(
                        str(self.set_cl.fit_orders[range_tab].get("width_fixed"))
                    )
                ...
                if (
                    ...
                    peak_object.width_fixed.setText(
                        str(self.set_cl.fit_orders[range_tab].get("height_fixed"))
                    )
                ...
                if (
                    ...
                    peak_object.width_fixed.setText(
                        str(self.set_cl.fit_orders[range_tab].get("d-space_fixed"))
                    )
            ...
            if "Polydefix" == self.set_cl.output_types[output]:
                ...
                for wid in output_object.WritePolydefix_required_list:
                    ...
                    for i in range(list_len):
                        if (
                            wid.objectName()
                            == cpf.output_formatters.WritePolydefix.Requirements()[0][i]
                        ):
                            wid.setText(
                                cpf.output_formatters.WritePolydefix.Requirements()[0][
                                    i
                                ]
                            )

            elif "CoefficientTable" == self.set_cl.output_types[output]:
                output_object.Output_Type_comboBox.setCurrentText(
                    "WriteCoefficientTable"
                )
                ...
                for wid in output_object.WriteCoefficientTable_optional_list:
                    ...
                    if "coefs_vals_write" in self.set_cl.output_settings:
                        if lineEdit.objectName() == "coefs_vals_write":
                            lineEdit.setText(
                                str(self.set_cl.output_settings["coefs_vals_write"])
                            )
                ...
                for wid in output_object.WriteCoefficientTable_required_list:
                    ...
                    for i in range(list_len):
                        if (
                            wid.objectName()
                            == cpf.output_formatters.WriteCoefficientTable.Requirements()[
                                0
                            ][i]
                        ):
                            wid.setText(
                ...
                for wid in output_object.WriteDifferentialStrain_required_list:
                    ...
                    for i in range(list_len):
                        if (
                            wid.objectName()
                            == cpf.output_formatters.WriteDifferentialStrain.Requirements()[
                                0
                            ][i]
                        ):
                            wid.setText(
                ...
                for wid in output_object.WriteMultiFit_required_list:
                    ...
                    for i in range(list_len):
                        if (
                            wid.objectName()
                            == cpf.output_formatters.WriteMultiFit.Requirements()[0][i]
                        ):
                            wid.setText(
                                cpf.output_formatters.WriteMultiFit.Requirements()[0][i]
                            )
                ...
                for wid in output_object.WritePolydefixED_optional_list:
                    ...
                    if "ElasticProperties" in self.set_cl.output_settings:
                        if lineEdit.objectName() == "ElasticProperties":
                            lineEdit.setText(
                                str(self.set_cl.output_settings["ElasticProperties"])
                            )
                    ...
                    if "Output_tc" in self.set_cl.output_settings:
                        if lineEdit.objectName() == "Output_tc":
                            lineEdit.setText(
                                str(self.set_cl.output_settings["Output_tc"])
                            )
                ...
                for wid in output_object.WritePolydefixED_required_list:
                    ...
                    for i in range(list_len):
                        if (
                            wid.objectName()
                            == cpf.output_formatters.WritePolydefixED.Requirements()[0][
                                i
                            ]
                        ):
                            wid.setText(
                                cpf.output_formatters.WritePolydefixED.Requirements()[
                                    0
                                ][i]
                            )
    ...
    def Run_Initial_Position(self):
        ...
        if self.input_file_path == None:
            ...
            try:
                cpf.XRD_FitPattern.initial_peak_position(
                    f"{self.input_file_path}", save_all=True
                )
                text = open(settings.log_file).read()
                self.Console_output.setText(text)
    ...
    def Execute_Fits(self):
        ...
        if self.input_file_path == None:
            ...
            try:
                cpf.XRD_FitPattern.execute(
                    f"{self.input_file_path}", save_all=True, parallel=False
                )
                text = open(settings.log_file).read()
    ...
    def Insert_Button(self):
        ...
        try:
            # Save range_tab data
            for range_object in range(len(self.range_list)):
                self.set_cl.fit_orders[range_object]["range"][0] = self.range_list[
                    range_object
                ].Range_min.text()
                self.set_cl.fit_orders[range_object]["range"][1] = self.range_list[
                    range_object
                ].Range_max.text()

                self.set_cl.fit_orders[range_object]["background"] = self.range_list[
                    range_object
                ].Range_Background_Val.text()

                if (
                    self.range_list[range_object].Background_Type.currentText()
                    == "Select Type"
                ):
                ...
                self.set_cl.fit_orders[range_object]["imax"] = self.range_list[
                    range_object
                ].Intensity_max.text()
                self.set_cl.fit_orders[range_object]["imin"] = self.range_list[
                    range_object
                ].Intensity_min.text()

                self.set_cl.fit_orders[range_object]["PeakPositionSelection"] = (
                    self.range_list[range_object].Peak_Pos_Selection.toPlainText()
                )

                # Save peak_tab data
                for peak_object in self.range_list[range_object].peak_list:
                    self.peak_indices = self.range_list[range_object].peak_list.index(
                        peak_object
                    )

                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "phase"
                    ] = peak_object.phase_peak.text()
                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "hkl"
                    ] = peak_object.hkl.text()

                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "d-space"
                    ] = peak_object.d_space_peak.text()
                    ...
                    if peak_object.d_space_type.currentText() == "Select Type":
                        ...
                        self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                            "d-space-type"
                        ] = peak_object.d_space_type.currentText()
                    ...
                    if peak_object.height_peak_type.currentText() == "Select Type":
                        ...
                        self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                            "height-type"
                        ] = peak_object.height_peak_type.currentText()
                    ...
                    if peak_object.profile_peak_type.currentText() == "Select Type":
                        ...
                        self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                            "profile-type"
                        ] = peak_object.profile_peak_type.currentText()
                    ...
                    if peak_object.width_peak_type.currentText() == "Select Type":
                        ...
                        self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                            "width-type"
                        ] = peak_object.width_peak_type.currentText()

                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "height"
                    ] = peak_object.height_peak.text()
                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "profile"
                    ] = peak_object.profile_peak.text()

                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "profile_fixed"
                    ] = peak_object.profile_fixed.text()

                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "width"
                    ] = peak_object.width_peak.text()
                    self.set_cl.fit_orders[range_object]["peak"][self.peak_indices][
                        "symmetry"
                    ] = peak_object.symmetry_peak.text()
            ...
            for output_object in self.output_list:
                ...
                if (
                    output_object.Output_Type_comboBox.currentText()
                    == "WriteCoefficientTable"
                ):
                    ...
                    for i in output_object.WriteCoefficientTable_optional_list:
                        if i.objectName() == "coefs_vals_write":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["coefs_vals_write"] = (
                                    i.text()
                                )
                    ...
                    output_object.Output_Type_comboBox.currentText() == "WriteMultiFit"
                ):
                    ...
                    for i in output_object.WriteMultiFit_optional_list:
                        if i.objectName() == "Output_NumAziWrite":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["Output_NumAziWrite"] = (
                                    i.text()
                                )

                elif (
                    output_object.Output_Type_comboBox.currentText() == "WritePolydefix"
                ):
                    ...
                    for i in output_object.WritePolydefix_optional_list:
                        ...
                        if i.objectName() == "datafile_StartNum":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["datafile_StartNum"] = (
                                    i.text()
                                )
                        ...
                        if i.objectName() == "datafile_EndNum":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["datafile_EndNum"] = (
                                    i.text()
                                )
                        ...
                        if i.objectName() == "datafile_NumDigit":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["datafile_NumDigit"] = (
                                    i.text()
                                )
                    ...
                    for i in output_object.WritePolydefixED_optional_list:
                        ...
                        if i.objectName() == "ElasticProperties":
                            if i.text() == "":
                                ...
                                self.set_cl.output_settings["ElasticProperties"] = (
                                    i.text()
                                )
    ...
    def Insert_Range(self):
        ...
        self.set_cl.fit_orders.append(
            {"range": [1, 2], "background": [0, 0], "peak": [], "imin": 1, "imax": 1},
        )
