...
class Output(QWidget):
    def __init__(self):
        ...
        loadUi("Widgets/cpf.gui.output_widget.ui", self)
        ...
        if self.Output_Type_comboBox.currentText() == "WritePolydefix":
            ...
            for wid in range(self.req_item1):
                ...
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WritePolydefix.Requirements()[1][wid]
                )
            ...
            for wid in range(0, self.req_item11):
                ...
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WritePolydefix.Requirements()[0][wid]
                )
                self.lineEdit.setMinimumHeight(30)
            ...
            # Optional
            self.req_item2 = len(
                cpf.output_formatters.WriteCoefficientTable.Requirements()[1]
            )
            childcount = self.gridLayout_3.count()
            ...
            for wid in range(0, self.req_item2):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteCoefficientTable.Requirements()[1][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_3.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            # Required
            self.req_item12 = len(
                cpf.output_formatters.WriteCoefficientTable.Requirements()[0]
            )
            childcount2 = self.gridLayout_2.count()
            ...
            for wid in range(0, self.req_item12):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox_2)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteCoefficientTable.Requirements()[0][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_2.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            # Optional
            self.req_item3 = len(
                cpf.output_formatters.WriteDifferentialStrain.Requirements()[1]
            )
            childcount = self.gridLayout_3.count()
            ...
            for wid in range(0, self.req_item3):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteDifferentialStrain.Requirements()[1][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_3.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            # Required
            self.req_item13 = len(
                cpf.output_formatters.WriteDifferentialStrain.Requirements()[0]
            )
            childcount2 = self.gridLayout_2.count()
            ...
            for wid in range(0, self.req_item13):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox_2)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteDifferentialStrain.Requirements()[0][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_2.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            for wid in range(0, self.req_item4):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteMultiFit.Requirements()[1][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_3.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            for wid in range(0, self.req_item14):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox_2)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WriteMultiFit.Requirements()[0]
                )
                self.lineEdit.setMinimumHeight(30)
                ...
                self.label_2.setObjectName("label_2")
                self.label_2.setText(
                    cpf.output_formatters.WriteMultiFit.Requirements()[0][wid]
                )
                self.gridLayout_2.addWidget(self.label_2, n, 0, 1, 1)
                n += 1
            ...
            # Optional
            self.req_item5 = len(
                cpf.output_formatters.WritePolydefixED.Requirements()[1]
            )
            childcount = self.gridLayout_3.count()
            ...
            for wid in range(0, self.req_item5):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WritePolydefixED.Requirements()[1][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_3.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
            ...
            for wid in range(0, self.req_item15):
                self.lineEdit = QtWidgets.QLineEdit(self.groupBox_2)
                self.lineEdit.setObjectName(
                    cpf.output_formatters.WritePolydefixED.Requirements()[0][wid]
                )
                self.lineEdit.setMinimumHeight(30)
                self.gridLayout_2.addWidget(self.lineEdit, n, 2, 1, 1)
                self.label_2 = QtWidgets.QLabel(self.groupBox)
