...
def WriteOutput(
    ...
    **kwargs,
    ...
    if isinstance(Phase, str):
        ...
        # must be true or none so find most common phase
        phase_name = []
        for x in range(num_subpatterns):
    ...
    for x in range(settings_class.image_number):
        ...
        text_file.write(
            "%8i        %s  %8.8g            %6.1f\n"
            % (x + 1, "{:<18}".format(diff_name), t, temp)
        )
